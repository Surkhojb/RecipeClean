...
public class RecipeRandomAdapter extends RecyclerView.Adapter<RecipeRandomAdapter.RecipeViewHolder> {

    List<Recipe> list;
    RecipeClickListener recipeClickListener;

    public RecipeRandomAdapter(){ list = new ArrayList<>();
    }

    @Override
    public RecipeRandomAdapter.RecipeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_recipe, parent,
                false);
    ...
    @Override
    public void onBindViewHolder(RecipeRandomAdapter.RecipeViewHolder holder, int position) {
