...
public class RecipeFavoritesAdapter extends RecyclerView.Adapter<RecipeFavoritesAdapter.RecipeViewHolder> {

    List<Recipe> list;
    RecipeClickListener recipeClickListener;

    public RecipeFavoritesAdapter(){ list = new ArrayList<>();}

    @Override
    public RecipeFavoritesAdapter.RecipeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_favorite_recipe, parent, false);
        return new RecipeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecipeFavoritesAdapter.RecipeViewHolder holder, int position) {
